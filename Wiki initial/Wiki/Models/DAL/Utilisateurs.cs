    ...
    public class Utilisateurs 
    {
         ...
         public void Add(Utilisateur u)
        {
            using (SqlConnection connexion = new SqlConnection(ConnectionString))
            {
                ...
                commande.Parameters.Add("prenom", SqlDbType.NVarChar).SqlValue = (u.Prenom == null ? string.Empty : u.Prenom);
                commande.Parameters.Add("nomFamille", SqlDbType.NVarChar).SqlValue = (u.NomFamille == null ? string.Empty : u.NomFamille);
        ...
        public void Update(Utilisateur u)
        {
            using (SqlConnection connexion = new SqlConnection(ConnectionString))
            {
                ...
                commande.CommandType = CommandType.StoredProcedure;
                commande.Parameters.Add("Id", SqlDbType.Int).SqlValue = u.Id;
        ...
        public void Update(int Id, string NouveauMDP)
        {
             using (SqlConnection connexion = new SqlConnection(ConnectionString))
            {
                ...
                commande.CommandType = CommandType.StoredProcedure;
                commande.Parameters.Add("id", SqlDbType.NVarChar).SqlValue = Id;
